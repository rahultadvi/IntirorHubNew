...
const Profile = () => {
    const { user, updateProfile, uploadCompanyLogo, loading } = useAuth();
            ...
            <div className="bg-white rounded-2xl shadow-md p-5 sm:p-6 mb-6">
                <div className="flex flex-col sm:flex-row sm:items-center gap-5">
                    ...
                    <div className="relative w-24 h-24">
                        ...
                        {user.role === "ADMIN" && (
                            <label className="absolute bottom-0 right-0 bg-blue-600 hover:bg-blue-700 text-white rounded-full w-7 h-7 flex items-center justify-center cursor-pointer shadow-lg">
                                +
                                <input
                                    type="file"
                                    accept="image/*"
